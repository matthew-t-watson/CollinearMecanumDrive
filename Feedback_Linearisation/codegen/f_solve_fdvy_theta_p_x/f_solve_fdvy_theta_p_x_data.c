 ...
 *
 * f_solve_fdvy_theta_p_x_data.c
 *
 * Code generation for function 'f_solve_fdvy_theta_p_x_data'
 *
 */
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "f_solve_fdvy_theta_p_x",            /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
/* End of code generation (f_solve_fdvy_theta_p_x_data.c) */
