 ...
 *
 * _coder_dvy_tau_api.c
 *
 * Code generation for function '_coder_dvy_tau_api'
 *
 */
  ...
  const emlrtMsgIdentifier *msgId))[4]
{
  ...
  void dvy_tau_api(const mxArray * const prhs[2], int32_T nlhs, const mxArray
                   *plhs[1])
{
  real_T (*in1)[8];
  real_T (*in2)[4];
  ...
  out1 = dvy_tau(&st, *in1, *in2);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(out1);
}

/* End of code generation (_coder_dvy_tau_api.c) */
