 ...
 * _coder_uFB_api.c
 *
 * Code generation for function '_coder_uFB_api'
 *
 */
  ...
  const emlrtMsgIdentifier *msgId))[3]
{
  ...
  void uFB_api(const mxArray * const prhs[2], int32_T nlhs, const mxArray *plhs
               [1])
{
  real_T (*v)[3];
  real_T (*in1)[8];
...
/* End of code generation (_coder_uFB_api.c) */
