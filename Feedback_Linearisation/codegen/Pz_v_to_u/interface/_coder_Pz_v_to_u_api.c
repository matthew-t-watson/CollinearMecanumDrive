 ...
 *
 * _coder_Pz_v_to_u_api.c
 *
 * Code generation for function '_coder_Pz_v_to_u_api'
 *
 */
  ...
  const emlrtMsgIdentifier *msgId))[3]
{
  ...
  void Pz_v_to_u_api(const mxArray * const prhs[2], int32_T nlhs, const mxArray *
                     plhs[1])
{
  real_T (*u)[3];
  real_T (*in1)[8];
  ...
  Pz_v_to_u(&st, *in1, *in2, *u);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*u);
}

/* End of code generation (_coder_Pz_v_to_u_api.c) */
