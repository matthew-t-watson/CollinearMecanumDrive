 ...
 *
 * _coder_body_vel_control_dw1_dw2_dtheta_pr_fun_api.c
 *
 * Code generation for function '_coder_body_vel_control_dw1_dw2_dtheta_pr_fun_api'
 *
 */
...
void body_vel_control_dw1_dw2_dtheta_pr_fun_api(const mxArray * const prhs[17],
  int32_T nlhs, const mxArray *plhs[3])
{
  ...
  fss_minus1_dvy0 = e_emlrt_marshallIn(&st, emlrtAliasP(prhs[11]),
    "fss_minus1_dvy0");
  vxr = e_emlrt_marshallIn(&st, emlrtAliasP(prhs[12]), "vxr");
  vyr = e_emlrt_marshallIn(&st, emlrtAliasP(prhs[13]), "vyr");
  dphir = e_emlrt_marshallIn(&st, emlrtAliasP(prhs[14]), "dphir");
  ...
  body_vel_control_dw1_dw2_dtheta_pr_fun(&st, *in1, *in2, Kv, Kdphi, Kr, Kw1,
    Kw2, theta_p_max, w1_max, w2_max, theta_pr, fss_minus1_dvy0, vxr, vyr, dphir,
    K_slow_dtheta_p, K_slow_theta_p, &dtheta_pr, &dw1, &dw2);
...
/* End of code generation (_coder_body_vel_control_dw1_dw2_dtheta_pr_fun_api.c) */
