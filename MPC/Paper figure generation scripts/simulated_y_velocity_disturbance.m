...
step = [
    ...
    repmat([0 0 0]', [1 steps-stepIndex+MPC.nr])
    ];
...
cleanfigure;
matlab2tikz('D:\Google_Drive\Latex\Thesis\Figures\MPC\simulated_y_velocity_disturbance_new.tex', 'height', '0.4\textheight', 'width', '0.95\linewidth', 'parseStrings', false)
